...
public interface Api {
    ...
    @GetMapping(value = ApiUrls.ADD_BOOK) ModelAndView newBook();
    @PostMapping(value = ApiUrls.ADD_BOOK) void addBook(BookDTO bookDTO, @RequestParam("file") MultipartFile file, HttpServletResponse response) throws IOException, InterruptedException;
